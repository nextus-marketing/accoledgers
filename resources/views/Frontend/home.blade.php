                ...
                <div class="col-lg-6">
                    ...
                    <div class="hero-content">
                        ...
                        <div class="hero-content-body wow fadeInUp" data-wow-delay="0.5s">
                            <p>AccoLedgers delivers precise, clean, and audit-ready books relied on by 500+ satisfied clients.</p>
                        </div>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="about-content">
                        ...
                        <div class="about-content-body wow fadeInUp" data-wow-delay="0.25s">
                            <p>At AccoLedgers, we support business owners with all their financial needs through advanced technology and dedicated human expertise. Our affordable and reliable solutions help you achieve complete financial clarity, accuracy, and control.</p>
                        </div>
                        ...
                        <div class="about-content-footer">
                            ...
                            <div class="about-company-service wow fadeInUp" data-wow-delay="0.5s">
                                ...
                                <div class="company-service-content">
                                    ...
                                    <p>At AccoLedgers, we deliver accurate, transparent, and audit-ready accounting solutions tailored to your business.</p>
                                </div>
                            </div>
        ...
        <div class="row section-row align-items-center">
            ...
            <div class="col-lg-6">
                <div class="section-title-content wow fadeInUp" data-wow-delay="0.25s">
                    <p>At AccoLedgers, we provide complete financial solutions designed to make your accounting simple, accurate, and stress-free.</p>
                </div>
            </div>
        </div>
        ...
        <div class="row gy-4">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="why-choose-item wow fadeInUp" data-wow-delay="0.20s">
                    ...
                    <div class="why-choose-body">
                        <h3>Bookkeeping</h3>
                        <p>At AccoLedgers, we deliver best-in-class bookkeeping solutions for businesses of all sizes...</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="why-choose-item wow fadeInUp" data-wow-delay="0.35s">
                    ...
                    <div class="why-choose-body">
                        <h3>Payroll</h3>
                        <p>AccoLedgers provides reliable and efficient payroll services backed by innovative processes...</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="why-choose-item wow fadeInUp" data-wow-delay="0.50s">
                    ...
                    <div class="why-choose-body">
                        ...
                        <p>AccoLedgers is your trusted partner for tax planning and accounting...</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="why-choose-item wow fadeInUp" data-wow-delay="0.80s">
                    ...
                    <div class="why-choose-body">
                        <h3>Incorporation</h3>
                        <p>With over a decade of experience, AccoLedgers provides seamless incorporation services...</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="why-choose-item wow fadeInUp" data-wow-delay="0.95s">
                    ...
                    <div class="why-choose-body">
                        ...
                        <p>AccoLedgers is home to qualified and experienced tax professionals...</p>
                    </div>
                </div>
            </div>
...
<!-- Cta Box Section Start -->
    ...
    <div class="container">
        ...
        <div class="row section-row align-items-center">
            ...
            <div class="col-lg-6">
                <div class="section-title-content wow fadeInUp" data-wow-delay="0.25s">
                    <p>AccoLedgers delivers customized financial solutions for businesses across various industries. Our expert accountants and tax specialists are equipped to handle the unique needs of every sector.</p>
                </div>
            </div>
        </div>
 ...
 <div class="page-pricing">
							...
							<div class="swiper-wrapper">
								...
								<div class="swiper-slide">
									<div class="testimonial-item">	
                                        ...
                                        <div class="testimonial-body">
                                           <p>AccoLedgers has made managing our books effortless. Their team is professional, accurate, and always available when we need guidance.</p>									
                                        </div>													
									</div>
								</div>
								...
								<div class="swiper-slide">
									<div class="testimonial-item">	
                                        ...
                                        <div class="testimonial-body">
                                           <p>Thanks to AccoLedgers, our payroll and tax filings are always on time and stress-free. Highly recommend their services!</p>									
                                        </div>													
									</div>
								</div>
								<!-- Testimonial Slide End -->
								...
								<div class="swiper-slide">
									<div class="testimonial-item">	
                                        ...
                                        <div class="testimonial-body">
                                           <p>The outsourced CFO services provided by AccoLedgers gave us strategic insights that helped our business grow efficiently.</p>									
                                        </div>													
									</div>
								</div>
								<!-- Testimonial Slide End -->
    ...
    <div class="container">
        <div class="row justify-content-center">
            ...
            <div class="col-lg-8">
                <div class="section-title-content wow fadeInUp" data-wow-delay="0.25s">
                    <p>AccoLedgers is dedicated to delivering innovative accounting and financial solutions that cater to the needs of businesses and individuals across industries.</p>
                </div>
            </div>
